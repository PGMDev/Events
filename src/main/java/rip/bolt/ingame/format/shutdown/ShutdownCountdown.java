package rip.bolt.ingame.format.shutdown;
...
import rip.bolt.ingame.utils.TimeFormatter;
...
public class ShutdownCountdown extends MatchCountdown {
    ...
    protected Component formatText() {
        return TextComponent.of(ChatColor.AQUA + "Server will shut down in " + TimeFormatter.seconds(remaining));
    }
