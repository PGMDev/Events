...
public class VetoCountdown extends MatchCountdown {
    ...
    public VetoCountdown(Match match, VetoRound vetoRound, String message, VetoController controller) {
        super(match);
    ...
    public void onTick(Duration remaining, Duration total) {
        ...
        if ((secondsLeft <= 10 && secondsLeft % 5 == 0) || (secondsLeft % 30 == 0 && origSeconds - secondsLeft > 20)) // announce it
            announceRemaining();
    }
    ...
    private void announceRemaining() {
        ...
        for (BaseComponent[] comp : vetoRound.describe().formatOptions(controller.remainingOptions(), controller.currentType()))
