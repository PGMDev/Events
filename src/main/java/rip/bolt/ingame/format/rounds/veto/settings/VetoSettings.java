...
public class VetoSettings extends RoundSettings {
    ...
    public VetoSettings(String id, Duration vetoTime, RoundSettings decider, int score, boolean scoring, boolean showInHistory, List<Veto> vetoList, List<VetoOption> options) {
    ...
    public TournamentRound newRound(TournamentFormat format, String id) {
        return new VetoSettings(id, vetoTime, decider, score, scoring(), showInHistory(), vetoList, options).newRound(format);
    }
